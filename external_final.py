...
json.dump(res,open(f"{ROOT}/external_validation_final.json","w"),indent=2,ensure_ascii=False)
# 图
...
plt.tight_layout(); plt.savefig(f"{ROOT}/fig_external.png",dpi=120,bbox_inches="tight")
